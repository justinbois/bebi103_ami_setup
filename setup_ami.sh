...
conda install -y scipy pandas numba scikit-image scikit-learn statsmodels bokeh arviz watermark tqdm matplotlib seaborn ipython jupyter jupyterlab nodejs xarray netcdf4 awscli;
